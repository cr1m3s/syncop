...
if __name__ == '__main__':
    ...
    params = [
        ("GEN10", GEN10),
        ("GEN10PLUS", GEN10PLUS),
        ("GEN10PLUS_2023_10_09_03",GEN10PLUS_2023_10_09_03),
        ("GEN11", GEN11),
        ("GEN11_2023_10", GEN11_2023_10),
        ("GEN11_2023_10_00_00", GEN11_2023_10_00_00)
        ]
    print("Input servers generation: ")
    for index, param in enumerate(params, 1):
        print(f'{index}. {param[0]}')

    user_input = int(input(">>"))
    generation = {}
    if  len(params) >= user_input > 0:
        generation = params[user_input-1][1]

    get_ilocfg(servers, generation)                                                          
    count_disks()
